...
public class AttributeStrategyUtil {
    ...
    public static final AllowableValue ATTRIBUTE_STRATEGY_KEEP_ALL = new AllowableValue("Keep All Attributes", "Keep All Attributes",
            "Any attribute will be of a Flowfile will be saved under the offset of the flowfile in the batch, later in a split function you can retrieve attributes in for the same flowfile.");
    ...
    public static final PropertyDescriptor ATTRIBUTE_STRATEGY = new PropertyDescriptor.Builder()
        ...
        .allowableValues(ATTRIBUTE_STRATEGY_ALL_COMMON, ATTRIBUTE_STRATEGY_ALL_UNIQUE, ATTRIBUTE_STRATEGY_KEEP_ALL)
    ...
    public static AttributeStrategy strategyFor(ProcessContext context) {
        ...
        if (ATTRIBUTE_STRATEGY_KEEP_ALL.getValue().equals(strategyName)) {
            return new KeepAllAttributeStrategy();
        }
