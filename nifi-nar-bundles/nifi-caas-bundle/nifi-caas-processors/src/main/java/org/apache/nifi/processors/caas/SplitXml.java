...
public class SplitXml extends AbstractProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) {
        ...
        final XmlSplitterSaxParser parser = new XmlSplitterSaxParser(xmlTree -> {
            ...
            split = attributeStrategy.updateSplitAttributes(session, split, fragmentIdentifier, numberOfRecords.getAndIncrement(), split.getAttribute(CoreAttributes.FILENAME.key()));
            splits.add(split);
        }, depth);
