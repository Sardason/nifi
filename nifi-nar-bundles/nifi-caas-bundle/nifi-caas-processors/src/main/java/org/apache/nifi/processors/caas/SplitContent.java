...
public class SplitContent extends AbstractProcessor {
    ...
    protected void init(final ProcessorInitializationContext context) {
        ...
        properties.add(AttributeStrategySplitUtil.ATTRIBUTE_STRATEGY);
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) {
        ...
        final String fragmentId = finishFragmentAttributes(session, flowFile, splitList, attributeStrategy);
     ...
     * @param source  source
     * @param splits  splits
     * @param attributeStrategy  attributeStrategy
     * @return generated fragment identifier for the splits
     */
    private String finishFragmentAttributes(final ProcessSession session, final FlowFile source, final List<FlowFile> splits, final AttributeSplitStrategy attributeStrategy) {
        ...
        for (int i = 1; i <= newList.size(); i++) {
            ...
            FlowFile newFF = attributeStrategy.updateSplitAttributes(session, ff, fragmentId, i, originalFilename);
            splits.add(newFF);
        }
        return fragmentId;
    }
