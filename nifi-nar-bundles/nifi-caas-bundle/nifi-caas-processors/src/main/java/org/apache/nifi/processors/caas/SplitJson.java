...
public class SplitJson extends AbstractJsonPathProcessor {
    ...
    public void onTrigger(final ProcessContext processContext, final ProcessSession processSession) {
        ...
        final AttributeSplitStrategy attributeStrategy = AttributeStrategySplitUtil.strategyFor(processContext);
        ...
        for (int i = 0; i < resultList.size(); i++) {
            ...
            split = attributeStrategy.updateSplitAttributes(processSession, split, fragmentId, i, split.getAttribute(CoreAttributes.FILENAME.key()));
            processSession.transfer(split, REL_SPLIT);
        }
