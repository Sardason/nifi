 ...
 */
package org.apache.nifi.processors.caas;
...
import org.apache.nifi.processors.caas.split.AttributeSplitStrategy;
import org.apache.nifi.processors.caas.split.AttributeStrategySplitUtil;
...
public class SplitText extends AbstractProcessor {
    ...
    static {
        properties = Collections.unmodifiableList(Arrays.asList(
                ...
                AttributeStrategySplitUtil.ATTRIBUTE_STRATEGY
        ));
    ...
    public void onTrigger(ProcessContext context, ProcessSession processSession) throws ProcessException {
        ...
        final AttributeSplitStrategy attributeStrategy = AttributeStrategySplitUtil.strategyFor(context);
        ...
        if (error.get()) {
            ...
            final List<FlowFile> splitFlowFiles = this.generateSplitFlowFiles(fragmentId, sourceFlowFile, headerSplitInfoRef.get(), computedSplitsInfo, processSession, attributeStrategy);
     ...
     */
    private List<FlowFile> generateSplitFlowFiles(String fragmentId, FlowFile sourceFlowFile, SplitInfo splitInfo, List<SplitInfo> computedSplitsInfo, ProcessSession processSession, final AttributeSplitStrategy attributeStrategy) {
        ...
        if ((computedSplitsInfo.size() == 0) && (headerFlowFile != null)) {
            ...
            splitFlowFile = this.updateAttributes(attributeStrategy ,processSession, splitFlowFile, 0, splitFlowFile.getSize(),
            ...
            while (itr.hasNext()) {
                ...
                if (proceedWithClone) {
                    ...
                    splitFlowFile = this.updateAttributes(attributeStrategy, processSession, splitFlowFile, computedSplitInfo.lineCount, splitFlowFile.getSize(), fragmentId, fragmentIndex++,
    ...
    private FlowFile updateAttributes(AttributeSplitStrategy attributeStrategy, ProcessSession processSession, FlowFile splitFlowFile, long splitLineCount, long splitFlowFileSize,
                                      String splitId, int splitIndex, String origFileName) {
        Map<String, String> attributes = new HashMap<>();
        splitFlowFile = attributeStrategy.updateSplitAttributes(processSession, splitFlowFile, splitId, splitIndex, origFileName);
